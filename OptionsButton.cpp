...
void OptionsButton::BackButton::onClick() {
    ...
    OptionsButton *optionsButton = new OptionsButton(gameManager,state, smgr, Vector2(0,0), Vector2(0,0), "", true);
    optionsButton->onClick();
    state->removeButton("Return");
}
...
void OptionsButton::TabButton::onClick() {
    ...
    DefaultsButton *defaultsButton = new DefaultsButton(gameManager,state, smgr, Vector2(200, height - 150), Vector2(140, 50), "Restore defaults", true);
